                    ...
                    <div class="custom-container">
                        <div class="skills-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom"><?php echo ($drakeskill_output['heading']); ?></h1>
                            </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="<?php echo esc_attr($drakeskill_loop['aclass']);?>">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            ...
                                            <h1 class="percent"><?php echo esc_html($drakeskill_loop['sper']); ?></h1>
                                        </div>
