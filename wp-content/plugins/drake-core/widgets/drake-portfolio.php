    ...
    protected function register_controls() {  
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .portfolio-items .portfolio-item h2 a'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'         => esc_html__( 'Title Typography', 'drake-core' ),
                'selector'      => 
                    '{{WRAPPER}} .portfolio-items .portfolio-item h2 a',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .portfolio-items .portfolio-item h2 a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .portfolio-items .portfolio-item h2 a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                    ...
                    <div class="custom-container">
                        <div class="portfolio-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom"><?php echo ($drakeportfolio_output['heading']); ?></h1>
                            </div>
                                    ...
                                    <div class="portfolio-item portfolio-full">
                                        <div class="portfolio-item-inner">
                                            ...
                                            <ul class="portfolio-categories">
                                                ...
                                                <li>
                                                     <a href=""><?php echo esc_html($drakeportfolio_loop['ttitle1']); ?></a>
                                                </li><?php endif;?><?php if(!empty($drakeportfolio_loop['ttitle2'] )): ?>
                                                <li>
                                                    <a href=""><?php echo esc_html($drakeportfolio_loop['ttitle2']); ?></a>
                                                </li><?php endif;?><?php if(!empty($drakeportfolio_loop['ttitle3'] )): ?>
                                                <li>
                                                    <a href=""><?php echo esc_html($drakeportfolio_loop['ttitle3']); ?></a>
                                                </li><?php endif;?>
                                            </ul>
                                        </div>
										<h2><a href="<?php echo esc_url($drakeportfolio_loop['ptitlelink']['url']); ?>"><?php echo esc_html($drakeportfolio_loop['ptitle']); ?></a></h2>
                                    </div>
