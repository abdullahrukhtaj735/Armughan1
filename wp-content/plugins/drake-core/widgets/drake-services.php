    ...
    protected function register_controls() {  
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .services-items .service-item h2'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'         => esc_html__( 'Title Typography', 'drake-core' ),
                'selector'      => 
                    '{{WRAPPER}} .services-items .service-item h2',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .services-items .service-item h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .services-items .service-item h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
                    ...
                    <div class="custom-container">
                        <div class="services-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom"><?php echo ($drakeservices_output['heading']); ?></span></h1>
                            </div>
        ...
        foreach ($drakeservices_output['list1'] as $drakeservices_loop):?>
                                <div class="service-item scroll-animation" data-animation="fade_from_bottom">
                                    ...
                                    <h2><?php echo esc_html($drakeservices_loop['stitle']); ?></h2>
