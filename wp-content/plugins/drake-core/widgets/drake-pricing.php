    ...
    protected function register_controls() {  
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .section-header h1'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .section-header h1' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .section-header h1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .section-header h1 span'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->start_controls_tab(
         ...
         $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .pricing-table-items .pricing-table .pricing-table-header h1'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'      => 
                    '{{WRAPPER}} .pricing-table-items .pricing-table .pricing-table-header h1',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}} .pricing-table-items .pricing-table .pricing-table-header h1 span'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'      => 
                    '{{WRAPPER}} .pricing-table-items .pricing-table .pricing-table-header h1 span',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .pricing-table-items .pricing-table .pricing-table-header h1 span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .pricing-table-items .pricing-table .pricing-table-header h1 span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                    ...
                    <div class="custom-container">
                        <div class="pricing-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom"><?php echo ($drakepricing_output['heading']); ?></h1>
                            </div>
                                    ...
                                    <div class="col-md-6 scroll-animation" data-animation="<?php echo esc_attr($drakepricing_loop['aclass']);?>">
                                        <div class="pricing-table">
                                            <div class="pricing-table-header">
                                                ...
                                                <h1><?php echo ($drakepricing_loop['pttitle']); ?></span></h1>
                                            </div>
                                            <ul class="feature-lists">
                                                <?php echo ($drakepricing_loop['featureslist']); ?>
                                            </ul>
                                            <a href="<?php echo esc_url($drakepricing_loop['btlink']['url']); ?>" class="theme-btn"><?php echo esc_html($drakepricing_loop['bttext']); ?></a>
                                        </div>
                                    </div><?php endforeach; endif;?>
                                </div>
                                <p class="info scroll-animation" data-animation="fade_from_bottom">
                                    <?php echo ($drakepricing_output['pdes']); ?><a href="<?php echo esc_url($drakepricing_output['dbtlink']['url']); ?>"><?php echo esc_html($drakepricing_output['dbttext']); ?></a>
                                </p>
                            </div>
