...
<video class="body-overlay" muted autoplay loop>
    ...
    <div class="left-sidebar">
        ...
        <h2 class="email"><?php echo esc_html($drake_options['email']); ?></h2>
        <h2 class="address"><?php echo esc_html($drake_options['basedin']); ?></h2>
        ...
        <a href="<?php echo esc_html($drake_options['hiremelink']); ?>" class="theme-btn">
            <i class="las la-envelope"></i> <?php echo esc_html($drake_options['hireme']); ?>
        </a>
    </div>
